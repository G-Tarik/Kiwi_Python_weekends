...
def main():
    ...
    print ('Searching flight through online Kiwi API...')
    s_rez = searchFlight(args.departure,args.arrival,dep_date,typeFlight,nightsToStay)
    if s_rez == 'err1':
        print ('Http request to Kiwi API failed.')
        return
    elif s_rez == 'err2':
        print ('No search results for requested flight.')
        return
        
    currency, bookingToken = s_rez 
